...
<td><form name="details" action="nokia1280.jsp">
    <TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <IMG 
                                border=0 
                                src="sunglasses/sunglass1.jpg"></TD></TR>
                                <TR>
                               ...
                               OKEY SUNGLASSES</DIV><FONT 
                                class=price>RS 2299</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4760">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
               ...
               <td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                href=""><IMG 
                                border=0 
                                src="sunglasses/sunglass2.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                                EMPORIO ARMANI SUNGLASSES</DIV><FONT 
                                class=price>RS 8399</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4761">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
...
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                href=""><IMG 
                                border=0 
                                src="sunglasses/sunglass3.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                               REEBOK SUNGLASSES</DIV><FONT 
                                class=price>RS 799</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4762">
...
<tr><td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                href=""><IMG 
                                border=0 
                                src="sunglasses/sunglass4.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                                PRADA SUNGLASSES</DIV><FONT 
                                class=price>RS 2599</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4763">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                href=""><IMG 
                                border=0 
                                src="sunglasses/sunglass5.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                               RAY BAN SUNGLASSES</DIV><FONT 
                                class=price>RS 1899</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4764">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                href=""><IMG 
                                border=0 
                                src="sunglasses/sunglass6.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                               NEW SUMMER SHADES</DIV><FONT 
                                class=price>RS 1299</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4765">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td></tr>
</table>
</body>
</html>