...
<td><form name="details" action="nokia1280.jsp">
    <TABLE style="HEIGHT: 300px" border=0>
                                ...
                                NUMERO UNO SHOES</DIV><FONT 
                                class=price>RS 1200</FONT><br>
					
					<input type="hidden" name="id" id="id" value="4737">
<input type="submit" name="Submit" class="det"	value="">
               ...
               <td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <TR>
                                <TD style="HEIGHT: 210px"> 
                                <IMG border=0 src="SHOES/shoes2.jpg"></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                                NUMERO UNO SHOES</DIV><FONT 
                                class=price>RS 1000<br>
					</FONT><input type="hidden" name="id" id="id" value="4738">
...
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <TR>
                                <TD style="HEIGHT: 210px"> 
                                <img border=0 src="SHOES/shoes3.jpg"></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                NUMERO UNO SHOES</DIV><FONT 
                                class=price>RS 1800
					</FONT><BR><input type="hidden" name="id" id="id" value="4739">
...
<tr><td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                NUMERO UNO SHOES</DIV><FONT 
                                class=price>RS 1400
					</FONT><BR><input type="hidden" name="id" id="id" value="4740">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                <TD style="HEIGHT: 210px"> 
<IMG border=0 src="SHOES/shoes5.jpg"></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                               NUMERO UNO SHOES</DIV><FONT 
                                class=price>RS 1500</FONT><br>
					<font class="price"></font><input type="hidden" name="id" id="id" value="4741">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
</tr>
</table>
</body>
