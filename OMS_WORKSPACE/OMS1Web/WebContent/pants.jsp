...
<td><form name="details" action="nokia1280.jsp">
    <TABLE style="HEIGHT: 300px" border=0>
                              ...
                              ELEGANT STYLE FORMALS</DIV><FONT 
                                class=price>RS 3700</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4778">
<input type="submit" name="Submit" class="det" value=""></TD></TR></TBODY></TABLE></form></td>
               ...
               <td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=DisplayName>
                               FORMAL PANT FOR MEN</DIV><FONT 
                                class=price>RS 3600</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4779">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
...
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                             BLACK FORMALS</DIV><FONT 
                                class=price>RS 3500</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4780">
...
<tr><td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                                BOTTOM TIGHT FORMALS</DIV><FONT 
                                class=price>RS 3500</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4781">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                <DIV class=DisplayName>
                                NEW STYLE FORMALS</DIV><FONT 
                                class=price>RS 3600</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4782">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                <DIV class=DisplayName>
                               FORMAL CASUAL WEAR</DIV><FONT 
                                class=price>RS 3600</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4783">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td></tr>
</table>
</body>
</html>