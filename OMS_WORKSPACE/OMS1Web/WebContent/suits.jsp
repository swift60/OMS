...
<td><form name="details" action="nokia1280.jsp">
    <TABLE style="HEIGHT: 300px" border=0>
                               ...
                               RAYMOND SUITS</DIV><FONT 
                                class=price>RS 4000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4754">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
               ...
               <td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=DisplayName>
                                RAYMOND SUITS</DIV><FONT 
                                class=price>RS 3200</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4755">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
...
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=DisplayName>
                               RAYMOND SUITS</DIV><FONT 
                                class=price>RS 3300</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4756">
...
<tr><td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
						...
						class="price"></font><input type="hidden" name="id" id="id" value="4757">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                               ...
                               RAYMOND SUITS</DIV><FONT 
                                class=price>RS 3500</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4758">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                              ...
                              RAYMOND SUITS</DIV><FONT 
                                class=price>RS 3500</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4759">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td></tr>
</table>
</body>
</html>