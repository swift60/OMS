...
<td><form name="details" action="nokia1280.jsp">
    <TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <IMG 
                                border=0 
                                src="watches/watches1.jpg"></TD></TR>
                                <TR>
                               ...
                               BEING HUMAN PREMIUM WATCHES</DIV><FONT 
                                class=price>RS 800</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4742">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
               ...
               <td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                href=""><IMG 
                                border=0 
                                src="watches/watches2.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                                BEING HUMAN PREMIUM WATCHES</DIV><FONT 
                                class=price>RS 500</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4743">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
...
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                href=""><IMG 
                                border=0 
                                src="watches/watches3.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                               BEING HUMAN PREMIUM WATCHES</DIV><FONT 
                                class=price>RS 699</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4744">
...
<tr><td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                href=""><IMG 
                                border=0 
                                src="watches/watches4.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                                BEING HUMAN PREMIUM WATCHES</DIV><FONT 
                                class=price>RS 400</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4745">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                href=""><IMG 
                                border=0 
                                src="watches/watches5.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                                BEING HUMAN PREMIUM WATCHES</DIV><FONT 
                                class=price>RS 499</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4746">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                href=""><IMG 
                                border=0 
                                src="watches/watches6.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                               ...
                               BEING HUMAN PREMIUM WATCHES</DIV><FONT 
                                class=price>RS 499</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4747">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td></tr>
</table>
</body>
</html>