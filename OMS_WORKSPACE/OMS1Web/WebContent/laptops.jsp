...
<td><form name="details" action="nokia1280.jsp">
    <TABLE style="HEIGHT: 300px" border=0>
						...
						class="price"></font><input type="hidden" name="id" id="id" value="4766">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
               ...
               <td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                href=""><IMG 
                                border=0 
                                src="laptops/laptop2.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                               SONY VAIO LAPTOP</DIV><FONT 
                                class=price>RS 39000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4767">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
...
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                href=""><img
                                border=0 
                                src="laptops/laptop3.jpg"></img></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                               TOSHIBA LAPTOP</DIV><FONT 
                                class=price>RS 33000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4768">
...
<tr><td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                href=""><IMG 
                                border=0 
                                src="laptops/laptop4.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                                COMPAQ LAPTOP</DIV><FONT 
                                class=price>RS 32000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4769">
<input type="submit" name="Submit"	class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                href=""><IMG 
                                border=0 
                                src="laptops/laptop5.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
                                ...
                                <DIV class=DisplayName>
                                LENOVO LAPTOP</DIV><FONT 
                                class=price>RS 37000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4770">
<input type="submit" name="Submit"	class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                href=""><IMG 
                                border=0 
                                src="laptops/laptop6.jpg"></A></TD></TR>
                                <TR>
                                <TD style="HEIGHT: 90px" 
                                 vAlign=top align=center>
                                <DIV class=ItemTag1></DIV>
						...
						class="price"></font><input type="hidden" name="id" id="id" value="4771">
<input type="submit" name="Submit"	class="det"	value=""></TD></TR></TBODY></TABLE></form></td></tr>
</table>
</body>
</html>