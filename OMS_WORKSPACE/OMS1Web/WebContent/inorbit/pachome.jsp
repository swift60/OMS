<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
	...
	<%@page import="com.OMS1.DataBean.PackerBean"%>
...
<li><a href="#"><span>packed order</span></a></li>
...
<table><tr><th width="60">ORDERNO</th><th width="260">DATE</th><th width="30">TIME</th><th width="120">VIEW DETAILS</th><th width="220">SEND TO SHIPPER</th><th width="600"></th></tr>

<%
String loggedin=(String)session.getAttribute("loggedin");

PackerManager amg= new PackerManager();
ResultSet a = amg.disporderpacker();
while(a.next())
{
