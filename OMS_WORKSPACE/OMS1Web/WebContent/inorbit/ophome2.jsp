<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
	...
	<%@page import="com.OMS1.DataBean.OperatorBean"%>
...
OperatorManager amg= new OperatorManager();
ResultSet a = amg.disporderoperator();
while(a.next())
{
