...
<td><form name="details" action="nokia1280.jsp">
    <TABLE style="HEIGHT: 300px" border=0>
                              ...
                              DESIGNER JEANS FOR MEN</DIV><FONT 
                                class=price>RS 3600</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4772">
<input type="submit" name="Submit" class="det" value=""></TD></TR></TBODY></TABLE></form></td>
               ...
               <td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=DisplayName>
                               GUCCI JEANS FOR MEN</DIV><FONT 
                                class=price>RS 36000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4773">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
...
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                              LEVI'S JEANS</DIV><FONT 
                                class=price>RS 4000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4774">
...
<tr><td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                                PEPE JEANS LONDON</DIV><FONT 
                                class=price>RS 3800</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4775">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                <DIV class=DisplayName>
                                PRADA JEANS FOR MEN</DIV><FONT 
                                class=price>RS 9000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4776">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                <DIV class=DisplayName>
                               WRANGLER JEANS</DIV><FONT 
                                class=price>RS 35000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4777">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td></tr>
</table>
</body>
</html>