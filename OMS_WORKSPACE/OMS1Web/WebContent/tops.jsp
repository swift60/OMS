...
<td><form name="details" action="nokia1280.jsp">
    <TABLE style="HEIGHT: 300px" border=0>
                             ...
                             PARTY WEAR TOPS</DIV><FONT 
                                class=price>RS 5500</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4790">
<input type="submit" name="Submit" class="det" value=""></TD></TR></TBODY></TABLE></form></td>
               ...
               <td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=DisplayName>
                               JEANS TOP</DIV><FONT 
                                class=price>RS 5800</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4791">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
...
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                             FRONT BEADED TOP</DIV><FONT 
                                class=price>RS 6200</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4792">
...
<tr><td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=DisplayName>
                               LONG TOPS</DIV><FONT 
                                class=price>RS 3700</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4793">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                <DIV class=DisplayName>
                                POLYSTER TOPS</DIV><FONT 
                                class=price>RS 2300</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4794">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                <DIV class=DisplayName>
                               RUCHED NECK TOPS</DIV><FONT 
                                class=price>RS 2700</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4795">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td></tr>
</table>
</body>
</html>