...
<td><form name="details" action="nokia1280.jsp">
    <TABLE style="HEIGHT: 300px" border=0>
                               ...
                               ROYAL EAR-RINGS</DIV><FONT 
                                class=price>RS 18000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4796">
<input type="submit" name="Submit"  class="det"	value=" class="det""></TD></TR></TBODY></TABLE></form></td>
               ...
               <td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=DisplayName>
                               PEARL EAR-RINGS</DIV><FONT 
                                class=price>RS 13000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4797">
...
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=ItemTag2>INORBIT</DIV>
                                <DIV class=DisplayName>
                               DIAMOND RING</DIV><FONT 
                                class=price>RS 25000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4798">
...
<tr><td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                ...
                                <DIV class=DisplayName>
                                DIAMOND RING</DIV><FONT 
                                class=price>RS 32000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4799">
<input type="submit" name="Submit"  class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                <DIV class=DisplayName>
                                GEM COLLECTION</DIV><FONT 
                                class=price>RS 58000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4800">
<input type="submit" name="Submit"  class="det"	value=""></TD></TR></TBODY></TABLE></form></td>
<td><form name="details" action="nokia1280.jsp"><TABLE style="HEIGHT: 300px" border=0>
                                <TBODY>
                                <TR>
                                ...
                                <DIV class=DisplayName>
                              DIAMOND EAR-RINGS</DIV><FONT 
                                class=price>RS 25000</FONT><BR><font
						class="price"></font><input type="hidden" name="id" id="id" value="4801">
<input type="submit" name="Submit" class="det"	value=""></TD></TR></TBODY></TABLE></form></td></tr>
</table>
</body>
</html>